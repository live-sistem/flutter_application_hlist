...
import 'package:hlist/components/drawor.dart';
import 'package:hlist/models/note.dart';
import 'package:hlist/models/note_database.dart';
import 'package:hlist/pages/beta_page_grid_popover.dart';
...
class _NotesPageState extends State<NotesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Provider.of<ThemeProvider>(context, listen: false).checked_Grid;
